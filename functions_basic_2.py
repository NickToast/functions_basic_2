...
#4 Values Greater Than Second - Write a function that accepts a list and creates a new list contianing only the values from the original list that are greater than its 2nd value
